package week6.TurtlePaint.src.main.java.com.pluralsight.forms;
 ...
 * Usage example:
 * <pre>
 * week6.TurtlePaint.src.main.java.com.pluralsight.forms.World basic = new week6.TurtlePaint.src.main.java.com.pluralsight.forms.World();
 * week6.TurtlePaint.src.main.java.com.pluralsight.forms.World fancy = new week6.TurtlePaint.src.main.java.com.pluralsight.forms.World(640, 480, Color.YELLOW);
 *
 * week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle t1 = new week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle(basic);
 * week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle t2 = new week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new week6.TurtlePaint.src.main.java.com.pluralsight.forms.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    public World(int width, int height, Color backgroundColor) {
        super("week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle week6.TurtlePaint.src.main.java.com.pluralsight.forms.World");
    ...
    /**
     * Should only called by the week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle class constructor
     */
    ...
    /**
     * Should only called by week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle class methods
     */
    ...
    /**
     * To be used by week6.TurtlePaint.src.main.java.com.pluralsight.forms.Turtle class only
